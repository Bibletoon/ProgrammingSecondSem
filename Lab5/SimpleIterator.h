...
public:
	...
	SimpleIterator& operator+=(difference_type rhs)
	{
		_pointer += rhs;
		return *this;
	}
	...
	friend SimpleIterator operator+(difference_type lhs, const SimpleIterator& rhs)
	{
		return SimpleIterator(lhs + rhs._poiter);
	}

	friend SimpleIterator operator-(difference_type lhs, const SimpleIterator& rhs)
	{
		return SimpleIterator(lhs - rhs._pointer);
	}
